...
public class NVPAPICaller
{
    ...
    // <API Username> with your business Username (in this case just testing account)
    //<Your API Password> with your API Password (in this case just testing account)
    //<Your Signature> with your Signature (in this case just testing account)
    public string APIUsername = "Danelstob-facilitator_api1.yahoo.com";
    private string APIPassword = "2HXNWQFMKSVDFSVM";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AwOMYtsMpHJIufORQXMeaYxPtRD2";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        // Url to return to (in this case just localhost)
        string returnURL = "http://localhost:44307/Checkout/CheckoutReview.aspx";
        ...
        encoder["BRANDNAME"] = "hlv1 Sample Application";
        ...
        using (hlv1.Logic.ShoppingCartActions myCartOrders = new hlv1.Logic.ShoppingCartActions())
        {
