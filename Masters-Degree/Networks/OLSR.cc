...
{
	ofstream outfile;
	outfile.open("olsr300n_Simulation_general.txt", ios::app);
	Ptr<Packet> packet;
	Address from;
...
int main (int argc, char *argv[])
{
	...
	outfile2.open("olsr300n_Simulation_results.txt", ios::app);
	...
	OlsrHelper olsr;
	olsr.Set ("PeriodicUpdateInterval", TimeValue (Seconds (periodicUpdateInterval)));
	...
	wifiPhy.EnableAsciiAll (ascii.CreateFileStream ("olsr300n.tr"));
	Simulator::Run ();
	Simulator::Destroy();
