...
namespace xnaplatformer
{
    public class FileManager
    {
        ...
        {
            //settings for reading from the text files
        ...
        {
            //code save content - saves the player's posistion when game loaded
            if (identifier == String.Empty)
                identifierFound = true;
            ...
            foreach (string att in attributes)
                attribute += "[" + att + "]"; //{Attribute1][Attribute2]
...
// player positioning will be loaded in format
// Load=[Attribute1][Attribute2]
//      [Content1][Content2]
//      [Content3][Content4]
...
//fileManager.SaveContent("Load/Map.txt"", attribute, content, "");
